...
class Fingerprint(Base):
    __tablename__ = "dejavu_fingerprints"
    ...
    ix_hash = Index('ix_dejavu_fingerprints_hash', hash, mysql_length=8)  # avoid total duplication of value
