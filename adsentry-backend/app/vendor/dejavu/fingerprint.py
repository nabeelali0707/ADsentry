...
import numpy as np
import matplotlib
# Force a non-interactive backend: this module is only ever used for
# spectrogram computation (plot=False), never for on-screen display, and a
# headless deployment (Render/Railway) has no GUI backend available.
matplotlib.use('Agg')
import matplotlib.mlab as mlab
import matplotlib.pyplot as plt
from scipy.ndimage import (
    maximum_filter, generate_binary_structure, iterate_structure, binary_erosion
)
import hashlib
